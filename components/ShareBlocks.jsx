...
export default function ShareBlocks({ shareUrl, pinterestMedia, text = "Nézd meg, mit ajánl a kalkulátor!" }) {
  ...
  return (
    <section className="relative mt-16">
      <h2 className="text-2xl md:text-3xl font-extrabold mb-6 shine-text">Oszd meg a varázslatot</h2>

      {/* Fekete alapú megosztók */}
      <div className="grid gap-3 sm:grid-cols-2">
        <a className="btn-primary" href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(urlUtm)}`} target="_blank" rel="noopener noreferrer">
          Facebook poszt
        </a>
        <a className="btn-primary" href={messenger} target="_blank" rel="noopener noreferrer">
          Messenger megosztás
        </a>
