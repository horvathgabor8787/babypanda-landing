  ...
  const categories = [
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Cumilanc/1000020447.png",
    ...
    },
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Cumilanc/ragcsalancok/1000025046.png",
    ...
    },
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Kulcstartok/20250319_143851_0000.png",
    ...
    },
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Cumilanc/Marokragcsa/image3.jpeg",
    ...
    },
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Landighoz/image01.jpeg",
    ...
    },
    {
      ...
      image:
        "https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Honap_kartyak/20250721_123751_0000.png",
  ...
  return (
    <main className="relative min-h-screen theme-rose">
      <Head>
        ...
        <meta
          name="description"
          content="Egyedi, névre szóló ajándékok babáknak – különleges, emlékezetes és eladós. Válaszd ki most a tökéletes meglepetést!"
        />
        <meta
          property="og:title"
          content="Baby Panda – Névre szóló, egyedi babaajándékok"
        />
        <meta
          property="og:description"
          content="Fedezd fel a legnépszerűbb névre szóló ajándékokat. Egyedi, különleges – csak neki."
        />
        <meta
          property="og:image"
          content="https://happybabysss.myshoprenter.hu/custom/happybabysss/image/data/Cumilanc/1000020447.png"
        />
      ...
      <section className="relative z-10 pt-16 pb-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="title-wave wave-animate hero-title text-3xl sm:text-4xl md:text-6xl font-extrabold shine-text">
            Névre szóló ajándék – csak neki
          </h1>
          <p className="mt-4 text-base md:text-lg text-neutral-300 max-w-prose mx-auto">
            Ne adj át tömegcikket. Lepd meg őt olyan ajándékkal, ami{" "}
            <strong>egyedi</strong>, <strong>személyes</strong> és{" "}
            <strong>emlékezetes</strong>.
          </p>
      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8">
       <h2 className="title-wave wave-animate text-2xl md:text-3xl font-extrabold mb-2 shine-text">
      ...
      <section className="relative z-10 mt-16 px-4 sm:px-6 lg:px-8 pb-24">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="title-wave wave-animate text-2xl md:text-3xl font-extrabold shine-text">
            Válaszd ki most az egyedi ajándékot
          </h2>
          <p className="mt-3 text-neutral-300">
            Ajándék, ami kitűnik a tömegből – és csak neki szól.
          </p>
          <div className="mt-6 flex justify-center">
            <PrimaryButton
              href="https://www.babypanda.hu/baba-ajandekok"
              target="_blank"
